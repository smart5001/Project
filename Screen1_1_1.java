...
public class Screen1_1_1 extends JFrame implements ActionListener
{
	public JLabel ti;
	...
	public void paneldesign()
	{
		...
		while(i<=9)
		{
			...
			o[0] = DataBase.UserPastFeesMap.get(sp)[i][0];
			o[1] = DataBase.UserPastFeesMap.get(sp)[i][1];
			o[2] = DataBase.UserPastFeesMap.get(sp)[i][2];
			def.addRow(o);
			i++;
		}
		p.add(pa);
