...
public class Screen1_3 extends JFrame implements ActionListener
{
	...
	{
		fe = new JLabel("Course Registration");
		fe.setBounds(50,0,200,25);
		p.add(fe);
		
		li = new JButton("Register for new course");
		li.setBounds(50,50,200,25);
		p.add(li);
		
		co = new JButton("View registered courses");
		co.setBounds(50,100,200,25);
		p.add(co);
		
		at = new JButton("View available courses");
	...
	public void actionPerformed(ActionEvent ae)
	{
		try
		{
			if(ae.getSource()==li)
			{
				Screen1_3_1 scb =new Screen1_3_1();
			...
			{
				Screen1_3_2 scc =new Screen1_3_2();
			...
			{
				Screen1_3_3 scd =new Screen1_3_3();
