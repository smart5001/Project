...
public class Screen2_2 extends JFrame implements ActionListener 
{
	public JFrame f = new JFrame("Add a Course");
	...
	{
		sid = new JLabel("Course Id: ");
		sid.setBounds(25,25,150,25);
		p.add(sid);
		
		pass = new JLabel("Course Name: ");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource()==l)
		{
			...
			{
				DataBase.addCourseMap(id.getText(),key.getText());
