...
public class Screen1_4 extends JFrame implements ActionListener
{
	...
	{
		fe = new JLabel("Attendance");
		fe.setBounds(50,0,200,25);
		p.add(fe);
		
		li = new JButton("View Attendance");
		li.setBounds(50,50,200,25);
		p.add(li);
		
		co = new JButton("Register Complaint");
		co.setBounds(50,100,200,25);
		p.add(co);
		
		at = new JButton("View Attendance Guidelines");
	...
	public void actionPerformed(ActionEvent ae)
	{
		try
		{
			if(ae.getSource()==li)
			{
				Screen1_4_1 scb =new Screen1_4_1();
			...
			{
				Screen1_4_2 scc =new Screen1_4_2();
			...
			{
				Screen1_4_3 scd =new Screen1_4_3();
