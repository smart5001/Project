...
public class Screen1_3_3 extends JFrame implements ActionListener
{
	public JLabel ti;
	...
	{
		ti = new JLabel("All available courses");
		...
		for(String sp : DataBase.CourseMap.keySet())
		{
			Object[] o =new Object[2];
			o[0]=sp;
			o[1]=DataBase.CourseMap.get(sp);
			def.addRow(o);
		}
		p.add(pa);
		b = new JButton("Back");
