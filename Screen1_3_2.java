...
public class Screen1_3_2 extends JFrame implements ActionListener
{
	public JLabel ti;
	...
	{
		ti = new JLabel("All registered courses");
		...
		//System.out.println("I am here");
				while(i<=9)
				{
					...
					o[0] = DataBase.UserCourseMap.get(sp)[i][0];
					o[1] = DataBase.UserCourseMap.get(sp)[i][1];
					o[2] = DataBase.CourseMap.get(DataBase.UserCourseMap.get(sp)[i][0]);
					def.addRow(o);
					i++;
				}
		p.add(pa);
